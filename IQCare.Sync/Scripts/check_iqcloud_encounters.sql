...
delete from iqcare_knh.[dbo].dtl_fb_DisabilityHTC   where Ptn_pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from iqcare_knh.[dbo].dtl_fb_HTCReferredTO  where Ptn_pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from iqcare_knh.[dbo].dtl_fb_InformationSourceHTC   where Ptn_pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from iqcare_knh.[dbo].dtl_fb_MARPsHTC   where Ptn_pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from iqcare_knh.[dbo].dtl_fb_ServicesGivenHTC  where Ptn_pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from iqcare_knh.[dbo].dtl_fb_VisitReasonHTC where Ptn_pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from iqcare_knh.[dbo].[DTL_FBCUSTOMFIELD_KNH_HTC_Form]  where Ptn_pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from  iqcare_knh.dbo.dtl_PatientContacts where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from  iqcare_knh.dbo.[DTL_PATIENTHOUSEHOLDINFO] where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));	
delete from  iqcare_knh.dbo.[DTL_RURALRESIDENCE] where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));	
delete from  iqcare_knh.dbo.[DTL_URBANRESIDENCE]  where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));	
delete from  iqcare_knh.dbo.[DTL_PATIENTHIVPREVCAREENROLLMENT]  where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));			
delete from  iqcare_knh.dbo.[DTL_PATIENTGUARANTOR]  where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));	
delete from  iqcare_knh.dbo.[DTL_PATIENTDEPOSITS]  where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));			
delete from  iqcare_knh.dbo.[DTL_PATIENTINTERVIEWER]  where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));	
delete from  iqcare_knh.dbo.[DTL_FBCUSTOMFIELD_Patient_Registration] 	 where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));	
delete from  iqcare_knh.dbo.ord_Visit where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from  iqcare_knh.dbo.mst_Patient where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
delete from  iqcare_knh.dbo.lnk_patientprogramstart where Ptn_Pk in (SELECT Ptn_Pk FROM iqcare_knh.dbo.mst_Patient WHERE (NOT (SyncId IS NULL)));
