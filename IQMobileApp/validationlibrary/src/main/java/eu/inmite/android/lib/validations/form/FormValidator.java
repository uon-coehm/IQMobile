...
public class FormValidator {
    ...
    public static void startLiveFragmentValidation(final Fragment fragment, View view, final IValidationCallback callback) {
        startLiveValidation(fragment, view, callback);
    }
