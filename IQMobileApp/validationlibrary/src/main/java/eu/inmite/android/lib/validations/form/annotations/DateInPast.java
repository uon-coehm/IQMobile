...
/**
 * Validate input as a date that should be in past. <br/>
 * {@link DateFormat} is used to parse input string. To specify the input format, set {@link #datePattern()} or {@link #dateStyle()}.
 *
