...
public class WizardFlow {
    ...
    public static class Builder {
         ...
         *
         * @param stepClass The class of {@link WizardStep} to create (if necessary)
         ...
         *
         * @param stepClass  The class of {@link WizardStep} to create (if necessary)
         * @param isRequired Determine if the step is required before advancing to the next step
         * @return Builder for creating a wizard flow
         */
